...
template <typename T>
concept AllowedType = 
std::is_same_v<T, Types::Data::Byte> ||
std::is_same_v<T, Types::Data::Word> ||
std::is_same_v<T, Types::Data::Dword> ||
std::is_same_v<T, Types::Data::Float> ||
std::is_same_v<T, Types::Data::Double> ||
std::is_same_v<T, Types::Data::IntPtr> ||
